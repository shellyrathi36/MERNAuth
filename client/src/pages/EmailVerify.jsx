...
const EmailVerify = () => {
  ...
  }, [isLoggedin, userData]); // if th user id alreday verified then he/she cannot use the email-verify path rememberrr!!!!!
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      >
        ...
        <button className="w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-3xl">
          Verify email
        </button>
      </form>
    </div>
